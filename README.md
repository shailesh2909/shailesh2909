<div align="center">
  <img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Shailesh%20Suryawanshi&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32"/>
</div>


<div align="center">

  [![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=32&duration=2800&pause=2000&color=A177F7&center=true&vCenter=true&width=940&lines=Hey!+I'm+Shailesh+Suryawanshi+%F0%9F%91%8B;Full+Stack+Developer+%7C+AI+Enthusiast;National+Level+Cybersecurity+Winner+%F0%9F%A5%87;Building+Intelligent+Systems+%F0%9F%9A%80;Open+for+Collaborations!)](https://git.io/typing-svg)
...
<p align="center">
  <a href="https://github.com/shailesh2909?tab=followers">
    <img alt="followers" title="Follow me on Github" src="https://custom-icon-badges.demolab.com/github/followers/shailesh2909?color=236ad3&labelColor=1155ba&style=for-the-badge&logo=person-add&label=Follow&logoColor=white"/></a>
  <a href="https://github.com/shailesh2909?tab=repositories&sort=stargazers">
    <img alt="total stars" title="Total stars on GitHub" src="https://custom-icon-badges.demolab.com/github/stars/shailesh2909?color=55960c&style=for-the-badge&labelColor=488207&logo=star"/></a>
  <img src="https://komarev.com/ghpvc/?username=shailesh2909&label=Profile%20views&color=blueviolet&style=for-the-badge" alt="shailesh2909" />
</p>
...
const shailesh = {
  ...
  reachMe: "shailesh82909@gmail.com",
...
<p align="center">
AI-powered telemedicine platform that predicts diseases 🧠, prioritizes patients 🚑, and connects them with verified doctors 🏥 in real-time.
</p>
...
**Key Features:**
- 🤖 AI-Powered Disease & Specialist Prediction
- 🚑 Automatic Severity Scoring & Smart Triage
- 🏥 Nearest Doctor Search for Quick Access
- 🔍 Doctor Credential Verification via Selenium
- 📅 Real-Time Appointment Booking with Global Time-Zone Support
- 🔐 Secure Firebase Real-Time Database Management
- 📱 Modern, Professional & Fully Responsive UI

**Impact Metrics:**
- 🎯 Smart AI-based healthcare automation
- ⚡ Faster patient-doctor connectivity
- 🛡️ Increased trust through verified doctor validation
- 📊 Improved care prioritization using severity scoring
...
<p align="center">
An Android-based centralized platform designed to simplify daily necessities for students and travelers by providing accommodation, mess services, and medical assistance in one place.
</p>
...
**Impact Metrics:**
- 🎓 Simplifying daily needs for students
- ⚡ Real-time service listings and instant updates
- 🔐 Secure and reliable user authentication
- 📈 Improved accessibility to essential services
- 📱 Optimized Android performance for smooth user experience

**Key Features:**
- 🏠 Centralized room rental discovery
- 🍽 Smart mess service comparison
- 🏥 Quick-access medical assistance
- 🔄 Firebase-powered real-time synchronization
- 🔐 Secure login with Firebase Authentication
- 📱 Clean and intuitive XML-based UI design
...
<p align="center">
A high-performance AI-powered Python tool that extracts, ranks, and summarizes the most relevant sections from complex PDFs using hybrid text extraction and semantic intelligence.
</p>
...
**Impact Metrics:**
- 📄 Intelligent hybrid PDF text extraction (Digital + OCR)
- ⚡ Parallel multi-core processing for faster document analysis
- 🧠 High-precision semantic relevance ranking
- 🌍 Accurate OCR support for 80+ languages
- 🐳 Portable and containerized deployment with Docker

**Key Features:**
- 📑 Hybrid text extraction using PDFPlumber + EasyOCR
- 🔍 Semantic ranking with all-MiniLM-L6-v2 embeddings
- 🧠 Context-aware extractive summarization
- ⚙️ Intelligent query generation with smart fallback logic
- 🚀 Multiprocessing-based parallel document handling
- 🐳 One-command Docker execution support
...
<br/>
  ...
  <a href="https://github.com/shailesh2909?tab=repositories">
...
<br/><br/>
<b>🥇 National Level Cyber Security Quiz Champion</b>
<br/>
<sub>ISTE Technical Symposium – Pursuit 2023</sub>
<br/>
<sub>Shri Sant Gajanan Maharaj College of Engineering, Shegaon</sub>
</td>
</tr>
</table>
...
<div align="center">
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=shailesh2909&bg_color=0d1117&color=6C63FF&line=6C63FF&point=FFFFFF&hide_border=true&area=true&area_color=6C63FF" width="98%"/>
</div>
...
<a href="https://www.linkedin.com/in/shailesh-suryawanshi-6989492a1/">
  <img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn"/>
</a>
<a href="mailto:shailesh82909@gmail.com">
